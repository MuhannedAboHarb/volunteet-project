    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                // القسم 2: التفاصيل المالية والموقع
                ...
                // القسم 3: نوع العقد وعمل عن بعد (حقول افتراضية)
                Forms\Components\Section::make('نوع العقد')
                    ->schema([
                        Forms\Components\Select::make('contract_type')
                            ...
                            ->default('دوام كامل')
                            ->dehydrated(false), // لا يحفظ في قاعدة البيانات
